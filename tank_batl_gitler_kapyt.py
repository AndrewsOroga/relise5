...
#pygame.display.set_caption("Гра - Битва танків")
...
class Tank2(pygame.sprite.Sprite):
    ...
    def shoot(self,bullet):
       ...
       # pygame.draw.rect(screen, self.rect, (self.x, HEIGHT - 50, 50, 50))
...
while True:
   ...
   # поява аптечок на карті
    ...
    #Усі колізії  ракети пулі аптечки і тд   
    ...
    if playing:
        ...
        # перезапускання гри після її закінчення
        ...
        # змінна кольору полоски хп обох танків
        ...
        #Написання тексту у верхніх кутах екрану
